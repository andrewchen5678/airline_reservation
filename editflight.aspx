<%@ Page Title="" Language="C#" MasterPageFile="~/mainmenu.master" AutoEventWireup="true" CodeFile="editflight.aspx.cs" Inherits="editflight" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:Panel ID="Panel1" runat="server">
        ...
        Flight Number:<asp:Label ID="FlightNumberLbl" runat="server" Text="Label"></asp:Label>
        <br />
        ...
        <br />
        <asp:Button ID="editBtn" runat="server" Text="Edit Flight" 
