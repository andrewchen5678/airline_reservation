<%@ Page Title="" Language="C#" MasterPageFile="~/mainmenu.master" AutoEventWireup="true" CodeFile="register.aspx.cs" Inherits="register" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div>
        ...
        <asp:Button ID="cancelBtn" runat="server" Text="Cancel" 
            CausesValidation="False" onclick="cancelBtn_Click" UseSubmitBehavior="False" />
        <br />
